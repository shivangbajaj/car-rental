...
<div class="tab">
  ...
  <button class="tablinks" onclick="openContent(event, 'profile')" id="defaultOpen">Account Settings</button>
...
<nav id="footer" style="background-color:black;color:white;padding:10px; margin-top:646px;">
  <div class="container">
    <div class="pull-left">
      <p> 2018. &copyAll Rights Reserved. Designed and coded by <a href="https://www.instagram.com/?hl=en" target="_blank">Shivang</a></p>
    </div>
