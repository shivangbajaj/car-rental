...
if(isset($_POST['startloc'])){
	$_SESSION['startloc'] = $_POST['startloc'];
  $_SESSION['endloc'] = $_POST['endloc'];
}
else{
	$_SESSION['endloc']=$en;
	$_SESSION['startloc']=$st;
}
$st=$_SESSION['startloc'];
$en=$_SESSION['endloc'];  
...
<p>&nbsp;&nbsp;From when do you need Car?</p>
<label>&nbsp;&nbsp;&nbsp;&nbsp;Start Date</label><br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="date" name="startdate" required placeholder="&nbsp;&nbsp;&nbsp;Starting Date" style="height:40px;width:520px;font-size:25px;margin-bottom:20px;"><!---<input type="text" id="datepicker" name="startdate" required placeholder="&nbsp;&nbsp;&nbsp;Starting Date" style="height:40px;width:520px;font-size:25px;margin-bottom:20px;">---><br><br>
<label>&nbsp;&nbsp;&nbsp;&nbsp;Start Time</label><br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="time" name="starttime" required placeholder="&nbsp;&nbsp;&nbsp;Starting Date" style="height:40px;width:520px;font-size:25px;margin-bottom:20px;">
